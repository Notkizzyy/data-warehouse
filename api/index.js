...
const app = express();
// Allow specific origin or all if not configured (Vercel sets origin)
app.use(cors());
...
// Vercel Serverless expects the app to be exported, not listen locally.
// But we can fallback to listening if not deployed.
